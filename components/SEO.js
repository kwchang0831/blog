...
const CommonSEO = ({ title, description, ogType, ogImage, twImage, robots }) => {
  ...
  return (
    <Head>
      ...
      <meta name="publisher" content={siteMetadata.siteUrl} />
      <link rel="canonical" href={`${siteMetadata.siteUrl}${router.asPath}`} />
    </Head>
  )
}

export const PageSEO = ({ title, description, robots }) => {
